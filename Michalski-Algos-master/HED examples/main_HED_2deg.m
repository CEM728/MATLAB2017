...
num = 200; %Size of the arrays 200 is a good number
%% Global Parameters
...
%     matlab2tikz('filename',sprintf('figures/Gxx_25.tikz'),'showInfo', false)
%     
% %         ylabel('$G_{zz}^{\mathrm{A}}$','interpreter','latex')
% %         matlab2tikz('filename',sprintf('figures/Gzz_25.tikz'),'showInfo', false)
% else
%     
%     ylabel('$G_{zx}^{\mathrm{A}}$','interpreter','latex')
%     matlab2tikz('filename',sprintf('figures/Gzx_25.tikz'),'showInfo', false)
% end
