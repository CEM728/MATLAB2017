...
% Changed engine calls to utils.* - Alex Barnett 10/9/12
...
if presortflag
    ...
    % Call mex engine
    if doubleengine
        [in on] = utils.insidepoly_dblengine(x, y, Px1, Py1, Px2, Py2, ontol, ...
                                       first, last);
    else % single arrays
        [in on] = utils.insidepoly_sglengine(x, y, Px1, Py1, Px2, Py2, ontol, ...
                                       first, last);
    end
